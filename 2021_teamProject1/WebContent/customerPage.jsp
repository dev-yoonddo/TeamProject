		...
		<div class="board-container">
			<div class="row">
				<table class="table table-striped" style="text-align: center; border: 3px solid #ffffff; ">
					<thead>
						<tr>
							<th style="background-color: #dcdcdc; text-align: center;">번호</th>
							<th style="background-color: #dcdcdc; text-align: center;">제목</th>
							<th style="background-color: #dcdcdc; text-align: center;">작성자</th>
							<th style="background-color: #dcdcdc; text-align: center;">작성일</th>
					...
					<tbody>
						...
						%>
						<tr>
							<td style="background-color: #e2efff"><%= list.get(i).getBoardID() %></td>
