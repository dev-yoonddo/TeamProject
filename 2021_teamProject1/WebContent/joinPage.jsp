...
<div class="join-section">
	<div class="join-form">
		...
		<form role="form" action="joinAction.jsp" method="post" onsubmit="return passwordCheck(this)">
		  ...
		  <div class="mb-3">
		    <input type="text" name="userName" id="userName" class="form-control input-lg" placeholder="이름 입력">
		  </div>
		  <div class="mb-3">
		    <input type="text" name="userBirth" id="userBirth" class="form-control input-lg" placeholder="생년월일 입력">
		  </div>
		  <div class="mb-3">
		    <input type="text" name="userPhone" id="userPhone" class="form-control input-lg" placeholder="핸드폰번호 입력">
		  </div>
		...
		<button type="button" class="btn-black" onclick="location.href='loginPage.jsp'"><span>로그인</span></button>
		</div>
		</form>
	</div>
</div>	
